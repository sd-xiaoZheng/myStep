package org.zaohu.utils.threadUtils;

import org.zaohu.config.threadConfig.MyThreadFactory;
import org.zaohu.config.threadConfig.ThreadRejectedExecutionHandler;
...
public class ThreadPoolUtils {
    ...
    /**
     * 系统可用计算资源
     * int CPU_COUNT = Runtime.getRuntime().availableProcessors();  // CPU 密集型
     * int CPU_COUNT = 3 * Runtime.getRuntime().availableProcessors();  // I/O 密集型
     */
     ...
     * 空闲线程存活时间
     */
    private static final Long KEEP_ALIVE_SECONDS = 30000000000L;
