...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'localhost:18888/api'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'localhost:18888/api'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'localhost:18888/api'
